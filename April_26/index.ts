...
//if else ki condition
let practiceDays : string = "Monday"
...
//*************************************************tinary operator
let _isGuest = false;
let _refreshment = _isGuest?  "biryani" :  "koorma";
